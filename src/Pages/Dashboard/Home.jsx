  ...
  return (
    <div className="p-2 md:p-4 space-y-4 md:space-y-6">
      ...
      <div className="flex flex-col xl:flex-row gap-10 rounded-lg">
        {/* Line Chart Section */}
        <div className="w-full xl:flex-1 border border-primary bg-white rounded-lg p-6">
          <LineChart />
        </div>

        {/* Card Section */}
        <div className="w-full xl:w-1/3 bg-white border border-primary p-6 rounded-lg">
